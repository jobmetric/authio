...
@section('content')
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <style>body { background-image: url({{ asset('assets/vendor/authio/media/background/bg4.jpg') }}); } [data-bs-theme="dark"] body { background-image: url({{ asset('assets/vendor/authio/media/background/bg4-dark.jpeg') }}); }</style>
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            ...
            <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
                <div class="bg-body rounded-4 w-md-550px position-relative">
