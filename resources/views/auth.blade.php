...
@section('body')
    <form class="form w-100 pt-20" action="">
        <div id="form-auth" class="form-data ">
                ...
                <div class="col">
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        ...
                        <div class="nav-group nav-group-outline">
                            <button class="form-auth-change-data btn btn-color-gray-600 btn-active btn-active-secondary fs-6 px-4 py-1 me-2 active" data-type="mobile">{{ trans('authio::base.page.auth.mobile') }}</button>
                            <button class="form-auth-change-data btn btn-color-gray-600 btn-active btn-active-secondary fs-6 px-4 py-1" data-type="email">{{ trans('authio::base.page.auth.email') }}</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row fv-row mb-8">
                <div class="col">
                    <div id="form-auth-mobile" class="form-auth-data-mode active">
                        <div class="row">
                            <div class="col-8">
                                <input type="number" id="mobile" autocomplete="off" class="form-control form-control-solid me-3 flex-grow-1" min="0" placeholder="{{ trans('authio::base.page.auth.mobile_placeholder') }}"/>
                            </div>
                            <div class="col-4">
                    ...
                    <div id="form-auth-email" class="form-auth-data-mode">
                        <input type="email" id="email" autocomplete="off" class="form-control form-control-solid" placeholder="{{ trans('authio::base.page.auth.email_placeholder') }}"/>
        ...
        <div id="form-code" class="form-data ">
            <div class="d-flex justify-content-between">
                ...
                <a href="javascript:void(0)" id="back-form-auth" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title="{{ trans('authio::base.page.buttons.change') }}">
            ...
            <div class="row fv-row mb-8 flex-row-reverse">
                <div class="col">
                    <input type="number" id="code-1" autocomplete="off" class="form-control form-control-solid text-center form-code-number" data-code-number="1"/>
                </div>
                <div class="col">
                    <input type="number" id="code-2" autocomplete="off" class="form-control form-control-solid text-center form-code-number" data-code-number="2"/>
                </div>
                <div class="col">
                    <input type="number" id="code-3" autocomplete="off" class="form-control form-control-solid text-center form-code-number" data-code-number="3"/>
                </div>
                <div class="col">
                    <input type="number" id="code-4" autocomplete="off" class="form-control form-control-solid text-center form-code-number" data-code-number="4"/>
                </div>
                <div class="col">
                    <input type="number" id="code-5" autocomplete="off" class="form-control form-control-solid text-center form-code-number" data-code-number="5"/>
                </div>
            </div>
            <div class="d-flex justify-content-between mb-7">
                <div>
                    <a href="javascript:void(0)" id="btn-login-by-password" class="text-primary fw-semibold fs-6">{{ trans('authio::base.page.buttons.login_password') }}</a>
                </div>
                <div>
                    <span id="timer" class="text-primary fw-semibold fs-6 active"></span>
                    <a href="javascript:void(0)" id="btn-resend">{{ trans('authio::base.page.buttons.resend') }}</a>
                </div>
            </div>
            <div class="row mb-10">
                <div class="col-12">
        ...
        <div id="form-password" class="form-data ">
            ...
            <div class="row fv-row mb-8 flex-row-reverse">
                <div class="col position-relative">
                    <input type="password" id="password" autocomplete="off" class="form-control form-control-solid text-center"/>
                    <div id="change-type-password">
            ...
            <div class="d-flex justify-content-between mb-7">
                <div>
                    <a href="javascript:void(0)" id="btn-login-by-code" class="text-primary fw-semibold fs-6">{{ trans('authio::base.page.buttons.login_code') }}</a>
                </div>
            </div>
            <div class="row mb-10">
                <div class="col-12">
                    <div class="d-grid">
                        <button id="btn-password" class="btn btn-primary">
                            <span class="indicator-label">{{ trans('authio::base.page.buttons.login') }}</span>
                        </button>
                    </div>
                </div>
        ...
        <div id="form-selection" class="form-data active">
            <div class="d-flex justify-content-between">
                <div class="text-right mb-20">
            ...
            <div class="row fv-row mb-8">
                <div class="col">
                    ...
                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-5 d-flex align-items-center mb-5 btn-selection" for="select-authenticator">
                        <div class="col-3">
                    ...
                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-5 d-flex align-items-center mb-5 btn-selection" for="select-sms">
                        <div class="col-3">
                    ...
                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-5 d-flex align-items-center mb-5 btn-selection" for="select-email">
                        <div class="col-3">
