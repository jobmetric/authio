...
return [
    ...
    */
    ...
    "exceptions" => [
        ...
        "user_not_match" => "کاربر با اطلاعات ارائه شده مطابقت ندارد.",
        "unauthorized" => "شما اجازه دسترسی ندارید.",
        "password_not_found" => "رمز عبور یافت نشد.",
    ],

    "messages" => [
        "request" => "بررسی انجام شد و شما به مرحله بعدی خواهید رفت.",
        "login" => "شما تا لحظاتی دیگر به پنل کاربری خود وارد خواهید شد.",
        "resend" => "کد احراز هویت مجددا برای شما ارسال شد.",
        "locked" => "لطفا بعد از :time ثانیه مجددا تلاش کنید.",
    ],
